 ...
 * @return {number} The value in the "data" space.
 */
export function editorToDataY(y, pageHeight, useFullbleed) {
  const offset = useFullbleed ? -DANGER_ZONE_HEIGHT : 0;
  return dataPixels(((y + offset) * PAGE_HEIGHT) / pageHeight);
}
