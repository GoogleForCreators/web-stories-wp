...
const DialogBox = styled.div`
  ...
  box-shadow: 0px 11px 15px -7px ${({ theme }) => rgba(theme.old.colors.bg.black, 0.2)},
    0px 24px 38px 3px ${({ theme }) => rgba(theme.old.colors.bg.black, 0.14)},
    0px 9px 46px 8px ${({ theme }) => rgba(theme.old.colors.bg.black, 0.12)};
  color: ${({ theme }) => rgba(theme.old.colors.bg.black, 0.87)};
...
const DialogContent = styled.div`
  ...
  font-size: 16px;
  line-height: 24px;
  color: ${({ theme }) => rgba(theme.old.colors.fg.black, 0.6)};

  b {
    color: ${({ theme }) => rgba(theme.old.colors.fg.black, 0.7)};
  }
`;
