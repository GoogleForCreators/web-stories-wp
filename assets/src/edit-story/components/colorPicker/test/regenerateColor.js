...
describe('regenerateColor', () => {
  ...
  it('should correctly generate color for conic gradient with default properties', () => {
    const state = {
      regenerate: true,
      type: 'conic',
      currentColor: { r: 0, g: 255, b: 0, a: 0.1 },
  ...
  it('should correctly generate color for conic gradient with non-default center only', () => {
    const state = {
      regenerate: true,
      type: 'conic',
      currentColor: { r: 0, g: 255, b: 0, a: 0.1 },
  ...
  it('should correctly generate color for radial conic with non-default alpha and rotation', () => {
    const state = {
      regenerate: true,
      type: 'conic',
      currentColor: { r: 0, g: 255, b: 0, a: 0.1 },
