...
export const TRIGGER_UPLOAD_MEDIA = 'TRIGGER_UPLOAD_MEDIA';
export const TRIGGER_UPLOAD_WITH_PREVIEW = 'TRIGGER_UPLOAD_WITH_PREVIEW';
export const TRIGGER_UPLOAD_VIDEO_POSTER = 'TRIGGER_UPLOAD_VIDEO_POSTER';
export const TRIGGER_GENERATE_POSTER = 'TRIGGER_GENERATE_POSTER';
