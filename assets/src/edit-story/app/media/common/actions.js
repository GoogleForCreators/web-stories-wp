...
export const fetchMediaError = (dispatch, defaultProvider) => ({ provider }) => {
  dispatch({
...
export const setNextPage = (dispatch, defaultProvider) => ({ provider }) => {
  dispatch({
...
export const deleteMediaElement = (dispatch, defaultProvider) => ({ provider, id }) => {
  dispatch({
