...
/**
 * @coversDefaultClass \Google\Web_Stories\Media\Video_Muting
 */
class Video_Muting extends Test_Case {
	/**
	 * @covers ::register
	 */
	public function test_register() {
		$video_muting = new \Google\Web_Stories\Media\Video_Muting();
	...
	public function test_register_meta() {
		...
		$this->assertTrue( registered_meta_key_exists( 'post', \Google\Web_Stories\Media\Video_Muting::IS_MUTED_POST_META_KEY, 'attachment' ) );
		$this->assertTrue( registered_meta_key_exists( 'post', \Google\Web_Stories\Media\Video_Muting::MUTED_ID_POST_META_KEY, 'attachment' ) );
	}
	...
	public function test_wp_prepare_attachment_for_js() {
		...
		$this->assertArrayNotHasKey( \Google\Web_Stories\Media\Video_Muting::IS_MUTED_KEY, $image );
		$this->assertArrayHasKey( \Google\Web_Stories\Media\Video_Muting::IS_MUTED_KEY, $video );
	}
	...
	public function test_rest_api_init() {
		...
		$this->assertArrayHasKey( \Google\Web_Stories\Media\Video_Muting::IS_MUTED_KEY, $data );
		$this->assertNull( $data[ \Google\Web_Stories\Media\Video_Muting::IS_MUTED_KEY ] );
	}
	...
	public function test_get_callback_is_muted() {
		...
		update_post_meta( $video_attachment_id, \Google\Web_Stories\Media\Video_Muting::IS_MUTED_POST_META_KEY, '1' );
