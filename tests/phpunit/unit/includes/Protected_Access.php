...
/**
 * Trait Protected_Access.
 *
 * Allows accessing protected methods and properties for testing.
 *
 * @internal
 */
trait Protected_Access {
	...
	/**
	 * Call a protected method as if it was public.
	 *
	 ...
	 */
	protected function call_protected_method( $object, $method_name, $args = [] ) {
	...
	/**
	 * Call a protected static method as if it was public.
	 *
	 ...
	 * @return mixed Return value of the method call.
	 */
	protected function call_protected_static_method( $class, $method_name, $args = [] ) {
	...
	/**
	 * Set a protected property as if it was public.
	 *
	 * @throws ReflectionException If the object could not be reflected upon.
	 *
	 ...
	 */
	protected function set_protected_property( $object, $property_name, $value ): void {
	...
	/**
	 * Get a protected property as if it was public.
	 *
	 * @throws ReflectionException If the object could not be reflected upon.
	 *
	...
	/**
	 * Get a static protected property as if it was public.
	 *
	 * @throws ReflectionException If the class could not be reflected upon.
	 *
	 ...
	 * @return mixed Return value of the property.
	 */
	protected function get_static_protected_property( $class, $property_name ) {
