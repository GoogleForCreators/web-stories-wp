...
|                                                                   | Remove background media                          | 🚨 **0.00%** *(0 / 1)*      |
...
| User can interact with menu using mouse                           | Click toggle button to open                      | 🛴 **75.00%** *(3 / 4)*     |
|                                                                   | *[total]*                                        | 🛴 **75.00%** *(3 / 4)*     |
|                                                                   | click close button to close menu                 | 🛴 **75.00%** *(3 / 4)*     |
| *\[total\]*                                                       | *\[total\]*                                      | 🛴 **72.84%** *(303 / 416)* |