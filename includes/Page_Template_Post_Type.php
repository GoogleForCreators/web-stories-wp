		...
		register_post_type(
			...
			[
				'labels'                => [
					...
					'featured_image'           => _x( 'Featured Image', 'template', 'web-stories' ),
					'set_featured_image'       => _x( 'Set featured image', 'template', 'web-stories' ),
					'remove_featured_image'    => _x( 'Remove featured image', 'template', 'web-stories' ),
					'use_featured_image'       => _x( 'Use as featured image', 'template', 'web-stories' ),
