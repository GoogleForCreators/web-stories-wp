...
class Assets {
	 ...
	 * @return string
	 */
	public function get_base_path( $path ): string {
	 ...
	 * @return string
	 */
	public function get_base_url( $path ): string {
	 ...
	 */
	protected function get_asset_metadata( $handle ): array {
	 ...
	 */
	public function register_style( $style_handle, $src, $deps = [], $ver = false, $media = 'all' ): bool {
		if ( ! isset( $this->register_styles[ $style_handle ] ) ) {
	 ...
	 */
	public function register_script( $script_handle, $src, $deps = [], $ver = false, $in_footer = false ): bool {
		if ( ! isset( $this->register_scripts[ $script_handle ] ) ) {
