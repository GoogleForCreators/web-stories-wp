...
class Assets {
	 ...
	 * @return string
	 */
	public function get_base_path( string $path ) {
	 ...
	 * @return string
	 */
	public function get_base_url( string $path ) {
	 ...
	 */
	protected function get_asset_metadata( string $handle ) {
	 ...
	 */
	public function register_style( string $style_handle, $src, array $deps = [], $ver = false, string $media = 'all' ) {
		if ( ! isset( $this->register_styles[ $style_handle ] ) ) {
	 ...
	 */
	public function register_script( string $script_handle, $src, array $deps = [], $ver = false, bool $in_footer = false ) {
		if ( ! isset( $this->register_scripts[ $script_handle ] ) ) {
