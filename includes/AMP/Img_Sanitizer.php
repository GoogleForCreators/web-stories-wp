 ...
 *
 * This version avoids using AMP_Image_Dimension_Extractor directly..
 *
 * @see AMP_Img_Sanitizer
 * @see AMP_Image_Dimension_Extractor
 *
 * @since 1.0.0
 */
class Img_Sanitizer extends AMP_Img_Sanitizer {
	/**
	 * Animation extension.
	 *
	 * @var string
	...
	private function determine_dimensions( $need_dimensions ) {
		...
		$dimensions_by_url = Image_Dimension_Extractor::extract( array_keys( $need_dimensions ) );
