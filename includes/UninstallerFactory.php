 ...
 */
class UninstallerFactory extends ServiceBasedPlugin {

	/**
	 * Create and return an instance of the Uninstaller.
	 *
	 ...
	 */
	public static function create(): Uninstaller {
		static $uninstaller = null;
