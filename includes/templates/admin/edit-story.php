...
$templates_rest_base        = $templates_post_type_object instanceof WP_Post && ! empty( $templates_post_type_object->rest_base ) ? $templates_post_type_object->rest_base : $templates_post_type_object->name;
