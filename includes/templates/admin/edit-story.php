...
$templates_rest_base        = isset( $templates_post_type_object ) && ! empty( $templates_post_type_object->rest_base ) ? $templates_post_type_object->rest_base : $templates_post_type_object->name;
