	...
	protected function get_args(): array {
		return [
			'labels'                => [
				...
				'add_new_item'             => __( 'Create New Story', 'web-stories' ),
				...
				'featured_image'           => _x( 'Poster Image', 'story', 'web-stories' ),
				'set_featured_image'       => _x( 'Set poster image', 'story', 'web-stories' ),
				'remove_featured_image'    => _x( 'Remove poster image', 'story', 'web-stories' ),
				'use_featured_image'       => _x( 'Use image as poster image', 'story', 'web-stories' ),
