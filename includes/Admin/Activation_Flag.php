...
class Activation_Flag implements ServiceInterface, Registerable {
	 ...
	 * @return bool
	 */
	public function set_activation_flag( bool $network_wide = false ) {
		if ( $network_wide ) {
	 ...
	 */
	public function get_activation_flag( bool $network_wide = false ) {
		if ( $network_wide ) {
	 ...
	 */
	public function delete_activation_flag( bool $network_wide = false ) {
		if ( $network_wide ) {
