...
describe('help center toggle <Toggle />', () => {
  it('should render', () => {
    const { getByRole } = renderWithTheme(<Toggle />);
  ...
  it('should have propper aria attributes when open', () => {
    ...
    const { getByRole } = renderWithTheme(<Toggle isOpen popupId={popupId} />);
  ...
  it('should fire onClick event when clicked', () => {
    ...
    const { getByRole } = renderWithTheme(<Toggle onClick={onClickMock} />);
