...
import { useFont } from '@web-stories-wp/fonts';
import { PAGE_WIDTH, ALLOWED_EDITOR_PAGE_WIDTHS } from '@web-stories-wp/units';
import { stripHTML } from '@web-stories-wp/design-system';
import { TextContentPropType } from '@web-stories-wp/elements';
...
FontPreview.propTypes = {
  ...
  element: TextContentPropType.isRequired,
