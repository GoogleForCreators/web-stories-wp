...
export const LOCAL_MEDIA_REMOVE_BASE_COLOR_PROCESSING =
  'LOCAL_MEDIA_REMOVE_BASE_COLOR_PROCESSING';
export const LOCAL_MEDIA_ADD_BASE_COLOR_PROCESSING =
  'LOCAL_MEDIA_ADD_BASE_COLOR_PROCESSING';
export const LOCAL_MEDIA_REMOVE_BLURHASH_PROCESSING =
  'LOCAL_MEDIA_REMOVE_BLURHASH_PROCESSING';
export const LOCAL_MEDIA_ADD_BLURHASH_PROCESSING =
  'LOCAL_MEDIA_ADD_BLURHASH_PROCESSING';
