 ...
 *
 * @param {string} actionName The event action (e.g. 'search'). The value that will appear as the event action in Google Analytics Event reports.
...
async function trackEvent(
  ...
  return track(actionName, eventData);
}
