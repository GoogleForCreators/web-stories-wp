...
import { editorPixels, PAGE_WIDTH, PAGE_HEIGHT } from '@web-stories-wp/units';
import { getMediaSizePositionProps } from '@web-stories-wp/media';
import { StoryElementBoxPropTypes } from '@web-stories-wp/elements';
...
MediaOutput.propTypes = {
  element: StoryElementPropTypes.media.isRequired,
