...
import { isMouseUpAClick } from '@web-stories-wp/design-system';
import {
  elementFillContent,
  generateParagraphTextStyle,
} from '@web-stories-wp/elements';
import { useStory, useCanvas } from '@web-stories-wp/story-editor';

/**
 * Internal dependencies
 */
import { StoryElementPropTypes } from '../types';
import getCaretCharacterOffsetWithin from './utils/getCaretCharacterOffsetWithin';
import { elementWithTextParagraphStyle, elementWithFont } from './utils/util';
...
TextFrame.propTypes = {
  element: StoryElementPropTypes.text.isRequired,
