...
describe('Stories Dashboard', () => {
  it('should be rename story', async () => {
    ...
    const [renameButton] = await page.$x("//button[contains(.,'Rename')]");
    await renameButton.click();
    await page.waitForTimeout(100);
    await expect(page).toMatchElement('input[value="Rename a story"]');
