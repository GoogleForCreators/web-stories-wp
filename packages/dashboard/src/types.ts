...
import type { Settings as DateSettings } from '@googleforcreators/date';
...
export interface DashboardSecondaryNavigationConfig {
  value: string;
  label: string;
  isExternal?: boolean;
...
export interface DashboardConfig {
  ...
  leftRailSecondaryNavigation: DashboardSecondaryNavigationConfig[];
