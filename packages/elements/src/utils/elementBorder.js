 ...
 */
import canElementHaveBorder from './canElementHaveBorder';
...
export function shouldDisplayBorder(element) {
  return hasBorder(element) && canElementHaveBorder(element);
}
...
export function getBorderRadius(element) {
  ...
  if (!borderRadius || !canElementHaveBorder(element)) {
    return {};
  }
 ...
 *
 * @param {Object} color Color object consisting rgba values.
