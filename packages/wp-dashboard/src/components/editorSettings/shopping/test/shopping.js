...
describe('Editor Settings: Shopping <Shopping />', function () {
  ...
  it('should render Woocmmerce inputs and helper texts', function () {
    renderWithProviders(
      <ShoppingSettings
  ...
  it('should render Woocmmerce inputs and activation message', function () {
    renderWithProviders(
      <ShoppingSettings
        shoppingProvider={SHOPPING_PROVIDER_TYPE.WOOCOMMERCE}
        shopifyHost=""
  ...
  it('should render Woocmmerce inputs and install message', function () {
    renderWithProviders(
      <ShoppingSettings
        shoppingProvider={SHOPPING_PROVIDER_TYPE.WOOCOMMERCE}
        shopifyHost=""
