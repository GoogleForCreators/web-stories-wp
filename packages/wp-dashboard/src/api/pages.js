 ...
 */
export function searchPages(config, searchTerm) {
  const path = addQueryArgs(config.api.pages, {
    per_page: 100,
    search: searchTerm,
 ...
 * @return {Promise} Request promise.
 */
export function getPageById(config, id) {
  const path = addQueryArgs(`${config.api.pages}${id}/`, {
