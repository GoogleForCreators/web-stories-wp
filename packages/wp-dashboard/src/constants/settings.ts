...
import type { DashboardSecondaryNavigationConfig } from '@googleforcreators/dashboard';

export const EDITOR_SETTINGS_ROUTE = '/editor-settings';

export const LEFT_RAIL_SECONDARY_NAVIGATION: DashboardSecondaryNavigationConfig[] =
  [
    {
