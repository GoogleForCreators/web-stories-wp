 ...
 */
import { PAGE_RATIO, FULLBLEED_RATIO } from '@web-stories-wp/units';
...
function CustomStyles() {
  ...
  // Match page background color to the workspace background color (theme.colors.bg.primary).
  // Validate since we're using dangerouslySetInnerHTML with imported variable.
  const pageBackgroundColor = '#131516';
