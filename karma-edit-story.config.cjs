...
module.exports = function (config) {
  ...
  config.set({
    ...
    files: [
      { pattern: '@web-stories-wp/karma-puppeteer-client', watched: false },
      { pattern: 'packages/story-editor/src/karma-tests.cjs', watched: false },
      { pattern: 'tests/karma/init.js', watched: false },
      {
        pattern: '__static__/**/*',
        watched: false,
        included: false,
    ...
    // Custom context file.
    customClientContextFile: 'tests/karma/client_with_context.html',
  });
};
