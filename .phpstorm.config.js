...
System.config({
  paths: {
    ...
    // Private Packages
    '@web-stories-wp/activation-notice': './packages-wp/activation-notice/src',
    '@web-stories-wp/commander': './packages-wp/commander/src',
    '@web-stories-wp/e2e-test-utils': './packages-wp/e2e-test-utils/src',
    '@web-stories-wp/e2e-tests': './packages-wp/e2e-tests/src',
    '@web-stories-wp/eslint-import-resolver': './packages/eslint-import-resolver/src',
    '@web-stories-wp/glider': './packages-wp/glider/src',
    '@web-stories-wp/imgareaselect': './packages-wp/imgareaselect/src',
    ...
    '@web-stories-wp/stories-block': './packages-wp/stories-block/src',
    '@web-stories-wp/stories-carousel': './packages-wp/stories-carousel/src',
    '@web-stories-wp/stories-lightbox': './packages-wp/stories-lightbox/src',
    '@web-stories-wp/tinymce-button': './packages-wp/tinymce-button/src',
    '@web-stories-wp/widget': './packages-wp/widget/src',
